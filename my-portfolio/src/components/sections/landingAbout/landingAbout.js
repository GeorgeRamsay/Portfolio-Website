...
import { IconPhone, IconMail, IconBrandLinkedin, IconMapPin } from '@tabler/icons-react';
            ...
            <div className={style.aboutBody}>
                ...
                <div className={style.aboutContent}>
                    ...
                    <div className={style.aboutText}>
                        ...
                        <div className={style.listOfContact}>
                            <div className={style.contactIconContainer}>
                                <IconMapPin size={30} className={style.contactIcon} />
